...
User("Instructions",1,"../programfiles/apps/addition.html","../images/icons/menu/user/instructions.png");
User("My Addition",1,"../programfiles/apps/addition.html","../images/icons/menu/user/user.png");
