...
boardGame("Battle Pong",1,"../programfiles/games/board/battlepong.swf","../images/icons/menu/games/board/battlepong.png",1);
...
boardGame("Connect 4",1,"../programfiles/games/board/connect4.swf","../images/icons/menu/games/board/connect4.png",1);
...
boardGame("Paper-Stone",1,"../programfiles/games/board/scissorspaperstone.swf","../images/icons/menu/games/board/scissorspaperstone.png",1);
...
boardGame("Hexxagon",1,"../programfiles/games/board/hexxagon.swf","../images/icons/menu/games/board/hexxagon.png",1);
boardGame("Portaball",1,"../programfiles/games/board/portaball.swf","../images/icons/menu/games/board/portaball.png",1);
boardGame("Reversi",1,"../programfiles/games/board/reversi.swf","../images/icons/menu/games/board/reversi.png",1);
